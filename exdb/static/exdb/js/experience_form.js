...
$(document).ready(function () {
    ...
    if (!$('#id_subtype option:selected').hasClass('no-verification')) {
    ...
    $('#id_subtype').change(function () {
        ...
        if ($('#id_subtype option:selected').hasClass('no-verification') && att_field.hasClass('hide') && con_field.hasClass('hide')) {
